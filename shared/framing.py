...
#used when the server or client receives a PDU that is not valid JSON or exceeds the maximum size
...
#encodes a PDU dict to bytes with a 4-byte length prefix
...
# reads a PDU, decodes it, and returns the dict
