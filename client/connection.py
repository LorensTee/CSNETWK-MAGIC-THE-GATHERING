...
class ClientConnection:
    ...
    async def recv_pdu(self) -> dict[str, Any]:
        ...
        # from ERROR PDUs (which echo the REJECTED action's older seq,
        # RFC §10.2.23) nor PONG PDUs (which echo the client's own lower
        # PING seq): adopting either would regress our counter and
        # permanently STALE-loop every later action.  Only
